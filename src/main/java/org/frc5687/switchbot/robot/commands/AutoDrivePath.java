...
public class AutoDrivePath extends Command {
    ...
    public AutoDrivePath(DriveTrain driveTrain, AHRS imu, double distance, double speed) {
        ...
        Trajectory.Config config = new Trajectory.Config(Trajectory.FitMethod.HERMITE_CUBIC, Trajectory.Config.SAMPLES_HIGH, 0.05, Constants.DriveTrain.CAP_SPEED_IPS * speed, 2.0, 60.0);
